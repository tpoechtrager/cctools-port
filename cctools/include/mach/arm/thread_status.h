...
#undef THREAD_STATE_NONE /* cctools-port */
...
#undef VALID_THREAD_STATE_FLAVOR /* cctools-port */
...
#undef MACHINE_THREAD_STATE /* cctools-port */
#undef MACHINE_THREAD_STATE_COUNT /* cctools-port */
